...
class XsValidator:
    ...
    def validateXmlInput (self, xmlInputFile, inputTreeWrapper, xsdFile=None, validateSchema=0):
        ...
        return self._validateXmlInput (xmlInputFile, inputTreeWrapper, xsdTreeWrapperList)
    ...
    def validateXmlInputString (self, inputTreeWrapper, xsdText=None, validateSchema=0):
        ...
        return self._validateXmlInput ("input text", inputTreeWrapper, xsdTreeWrapperList)
