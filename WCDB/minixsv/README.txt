Release Notes for minixsv, Release 0.8
...
- String characters > 0x80 not supported
- only a subset of escape characters for pattern matching supported
...
For documentation how to use minixsv please refer my homepage

http://www.leuthe-net.de/MiniXsv.html
